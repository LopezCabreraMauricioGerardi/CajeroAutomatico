...
/* la clase (propias) representa una interfaz gráfica de usuario para que pueda 
seleccionar una cuenta bancaria propia en uno de los cajeros automáticos,cabe recalcar que tambien la clase
extiende un JFrame,diseñada para mostrar diferentes componentes de la interfaz, y que gestiona
la selección de las cuentas bancarias */
...
public class Propias extends javax.swing.JFrame {
    ...
    String idioma;
     /** el constructor que inicializa la interfaz con los datos proporcionados por el usuario 
      @param ci     número de carnet de identidad del usuario para que verifique si es el prpietario
      @param cuenta número de cuenta del usuario ya sea de la moneda que escogio o creo.
    ...
    /*
     lee un archivo de texto con los datos de las cuentas y llena lo que es el JComboBox
     con las cuentas disponibles para el usuario, las cuentas que coinciden con
     el número de cuenta actual son omitidas.
     */
    ...
    try (BufferedReader br = new BufferedReader(new FileReader("src/Archivos/Datos.txt"))) {
        ...
        boolean skip = false; // es una bandera para saltar la lectura de cuentas si coinciden con el carnet y la cuenta
     ...
     /*
     cambia el idioma de la interfaz del usuario deaceurdo a su lenguaje.
     usa como parametro @param idioma nuevo idioma para la interfaz.
     */
  ...
  /*
     evento que se ejecuta cuando el usuario hace clic en el botón "Atrás".
     luego redirige al usuario a la pantalla anterior (ElegirT).
    ...
    /*
     evento que se ejecuta cuando el usuario selecciona una cuenta del JComboBox.
     redirige al usuario a la pantalla de transferencia (Transferir)
     @param evt Evento de acción.
     */
    ...
    /*
     destinamos una imagen como icono de un botón
     @param (buttonName) botón de accion al cual se le asignará el icono.
     @param (root)  indica la ruta de la imagen.
     */
